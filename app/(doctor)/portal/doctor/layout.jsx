...
const NAV_ITEMS = [
  { name: 'Dashboard', href: '/portal/doctor/dashboard', icon: LayoutDashboard },
  { name: 'Referred Patients', href: '/portal/doctor/patients', icon: Users },
  { name: 'Commissions', href: '/portal/doctor/commissions', icon: IndianRupee },
];
